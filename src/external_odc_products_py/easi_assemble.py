...
class EasiPrepare(Eo3Interface):
    ...
    def note_accessory_file(self, name: str, file_path: Path, relative_to_metadata: bool = True):
        """
    ...
    def write_eo3(self, validate_correctness: bool = True, sort_measurements: bool = True) -> tuple:
        """
